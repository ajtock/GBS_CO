...
# csmit -m 20G -c 1 "/applications/R/R-3.5.0/bin/Rscript ./crossover_SNPfreq_profiles_commandArgs_mid2SNPs_minWidth.R 5000 5kb 50 coller.filtarb collerF2.complete.tiger.txt"
