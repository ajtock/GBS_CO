...
# ./F2_CO_count_per_scaled_win_TelCen_excl_Chr5_excl_Lane1.R coller.wt 10
...
print(paste0(popName, "_pooled_F2_CO_frequency_", propName, "_TelCenMatrix_list_excl_Chr5.RData written to outDir"))
