...
# ./regression_Utests_F2_CO_count_per_scaled_win_TelCen_excl_Chr5.R coller.filt coller.hta7 10 0.1
...
load(paste0("./", pop1Name,
            ...
            propName, "_TelCenMatrix_list_excl_Chr5.RData"))
...
pdf(paste0(outDir, pop1Name, "_", pop2Name,
           ...
           propName, "_of_chromosome_arms_excl_Chr5.pdf"),
    height = 5, width = 10)
par(mfrow = c(1, 2))
...
pdf(file = paste0(UtestPlotDir,
                  ...
                  pop1Name, "_vs_", pop2Name, "_", propName, "_", FDRname, "_excl_Chr5.pdf"),
    height = 7, width = 7)
par(mfrow = c(2, 1))
par(mar = c(4.1, 4.1, 3.1, 4.1))
par(mgp = c(3, 1, 0))
...
pop1Vpop2GenomePlot(xplot = 1:length(pop1_winIndCOs_means),
                    ...
                    pop2Col = "forestgreen")
dev.off()
print(paste0("MannWhitneyWilcoxon_Pvals_TelCenProfiles_", pop1Name, "_vs_", pop2Name, "_", propName, "_", FDRname, "_excl_Chr5.pdf written to ", UtestPlotDir))
...
pop1Vpop2GenomePlot(xplot = 1:length(pop1_winIndCOs_means),
                    ...
                    pop2Col = "forestgreen")
dev.off()
print(paste0("NormalLinearRegression_Pvals_TelCenProfiles_", pop1Name, "_vs_", pop2Name, "_", propName, "_", FDRname, "_excl_Chr5.pdf written to ", plotDir))
