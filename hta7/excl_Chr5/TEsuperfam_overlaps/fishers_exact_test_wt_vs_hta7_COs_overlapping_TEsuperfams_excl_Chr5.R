...
# Compare proportions of wt and hta7 crossovers overlapping features using chi-square tests of independence

# Usage: 
# /applications/R/R-4.0.0/bin/Rscript fishers_exact_test_wt_vs_hta7_COs_overlapping_TEsuperfams_excl_Chr5.R coller.filt coller.hta7 wt hta7 "Pericentromeric crossovers" peri
