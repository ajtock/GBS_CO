...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_1profile.R HS_CU_crossovers 'Crossovers' 5000 5kb '5 kb' 50 50bp 'REC8_HA_Rep2' 'REC8-HA' 'red' '0.02,0.96'
