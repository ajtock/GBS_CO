...
pdf(paste0(plotDir, "GBS_coller_COs_base_relative_frequency_diffYaxes_v271119.pdf"), height = 5, width = 6)
par(mfrow = c(2, 2))
...
mergeBaseFreqPlotDiffY(at.coords = target.ATfreq, gc.coords = target.GCfreq,
                       ...
                       mainTitle1 = bquote("coller crossovers ("*italic("n")*" = "*.(prettyNum(length(targetsGR),
                                                                                        big.mark = ",", trim = T))*")"),
...
pdf(paste0(plotDir, "GBS_coller_COs_base_relative_frequency_v271119.pdf"), height = 5, width = 6)
par(mfrow = c(2, 2))
par(mar = c(2.1, 3.2, 2.1, 3.2))
par(mgp = c(2.25, 1, 0))
flankSize <- 5000
...
pdf(paste0(plotDir, "GBS_coller_COs_base_relative_frequency_AT_and_GC_diffYlims_v271119.pdf"), height = 10, width = 6)
par(mfrow = c(4, 2))
par(mar = c(2.1, 3.2, 2.1, 3.2))
par(mgp = c(2.25, 1, 0))
flankSize <- 5000
