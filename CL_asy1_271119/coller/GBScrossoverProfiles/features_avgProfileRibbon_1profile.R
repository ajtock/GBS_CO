...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_1profile.R coller_crossovers 'coller crossovers' 5000 5kb '5 kb' 50 50bp 'SPO11_1_oligos_RPI1' 'SPO11-1-oligos' 'red' '0.02,0.96'
