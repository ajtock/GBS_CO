...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_SerraUnderwood_COs_vs_ovule_hypermeth.R SerraUnderwood_COs 10000"

COsName <- "SerraUnderwood_COs"
perms <- 10000
...
#COs <- read.csv("/projects/ajt200/GBS_CO/Beth_190219/BR_wt_ColLer_F2/CO.all.with.420.flagged.csv", header = T)
