...
# ./2c_F2_CO_count_per_scaled_win_TelCen_Emma.R EL_wt_ColBur_F2_2019 5
...
# along left and right for each F2 individual
...
print(paste0(popName, "_pooled_F2_CO_frequency_", propName, "_TelCenMatrix_list.RData written to current working directory"))
