...
# Usage:
# Rscript ./logistic2_ajtEdit_v110520.R 1000 1
...
outDir <- paste0(winSize/1e3, "kbWin_", stepSize, "bpStep_SNPsPB/")
...
#[1]     10     27     56    118    301 127250
levels(cut(x = dat$width,
           breaks = c(min(dat$width, na.rm = T),
                      sort(dat$width)[round(1:6*(nrow(dat)/6))])))
#[1] "(2,10]"         "(10,27]"        "(27,56]"        "(56,118]"
#[5] "(118,301]"      "(301,1.27e+05]"
ssID <- split(x = 1:nrow(dat),
              f = cut(x = dat$width,
                      breaks = c(min(dat$width, na.rm = T),
                                 sort(dat$width)[round(1:6*(nrow(dat)/6))])))
pdf(paste0(plotDir, "GLM_binomial_logit_", winSize/1e3, "kbWin_", stepSize, "bpStep_SNPsPB_width_hexiles_CO_boxplot.pdf"))
boxplot(
  lapply(ssID, function(x) {
    sapply(1:100, function(ii) {
      sum( rbinom(n = length(x), size = 1, prob = glm_predict[x]) ) /
...
#                      breaks = c(min(dat$meanSPO11, na.rm = T),
#                                 sort(dat$meanSPO11)[round(1:6*(nrow(dat)/6))])))
#pdf(paste0(plotDir, "GLM_binomial_logit_", winSize/1e3, "kbWin_", stepSize, "bpStep_SNPsPB_SPO11_hexiles_CO_boxplot.pdf"))
#boxplot(
#  lapply(ssID, function(x) {
#    sapply(1:100, function(ii) {
#      sum( rbinom(n = length(x), size = 1, prob = glm_predict[x]) ) /
...
#                      breaks = c(min(dat$meanMNase, na.rm = T),
#                                 sort(dat$meanMNase)[round(1:6*(nrow(dat)/6))])))
#pdf(paste0(plotDir, "GLM_binomial_logit_", winSize/1e3, "kbWin_", stepSize, "bpStep_SNPsPB_MNase_hexiles_CO_boxplot.pdf"))
#boxplot(
#  lapply(ssID, function(x) {
#    sapply(1:100, function(ii) {
#      sum( rbinom(n = length(x), size = 1, prob = glm_predict[x]) ) /
...
#                      breaks = c(min(dat$meanH3K4me3, na.rm = T),
#                                 sort(dat$meanH3K4me3)[round(1:6*(nrow(dat)/6))])))
#pdf(paste0(plotDir, "GLM_binomial_logit_", winSize/1e3, "kbWin_", stepSize, "bpStep_SNPsPB_H3K4me3_hexiles_CO_boxplot.pdf"))
#boxplot(
#  lapply(ssID, function(x) {
#    sapply(1:100, function(ii) {
#      sum( rbinom(n = length(x), size = 1, prob = glm_predict[x]) ) /
...
#                      breaks = c(
#                                 sort(dat$meanDNAmeth)[round(1:6*(nrow(dat)/6))])))
#pdf(paste0(plotDir, "GLM_binomial_logit_", winSize/1e3, "kbWin_", stepSize, "bpStep_SNPsPB_DNAmeth_quintiles_CO_boxplot.pdf"))
#boxplot(
#  lapply(ssID, function(x) {
#    sapply(1:100, function(ii) {
#      sum( rbinom(n = length(x), size = 1, prob = glm_predict[x]) ) /
