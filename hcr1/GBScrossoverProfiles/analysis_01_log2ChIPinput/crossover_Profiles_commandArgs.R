...
# csmit -m 100G -c 2 "/applications/R/R-3.5.0/bin/Rscript ./crossover_Profiles_commandArgs.R 5000 5kb 20 /projects/ajt200/BAM_masters/SPO11-oligo/WT/coverage/log2ChIPinput/noZscore/log2wtSPO11oligoRPI1NakedDNA_norm_allchrs_coverage_coord_tab_noZscore.bed SPO11_1_oligos_RPI1"
...
featureListTab <- mclapply(seq_along(featureNames), function(x) {
  read.csv(paste0("/projects/ajt200/GBS_CO/hcr1/COs/", featureNames[x], ".cos.both.csv"),
           header = T)
